...
namespace Gestion_Matos
{
    public partial class interventions : Form
    {
        ...
        private void list_box_interventions_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Text_box_duree.Text = dr["Duree"].ToString();
            con.Close();
        }
        ...
        private void Btn_supprimer_Click(object sender, EventArgs e)
        {
            ...
            if (res == DialogResult.Yes)//sI l'utilisateur a cliquer sur le boutton OUI (Yes)
            {
                ...
                try
                {
                    ...
                    Text_box_intervention_id.Text = Text_box_intervention_materiel_id.Text = Text_box_intervention_date.Text = Text_box_intervention_comment.Text = Text_box_duree.Text = "";
        ...
        {
            list_materiel.Text = Text_box_intervention_id.Text = Text_box_intervention_materiel_id.Text = Text_box_intervention_date.Text = Text_box_intervention_comment.Text = Text_box_duree.Text= "";
        ...
        private void recap_Click(object sender, EventArgs e)
        {
            
                interrecap frm = new interrecap();
                frm.ShowDialog();
